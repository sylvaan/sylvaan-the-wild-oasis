...
function List({ id, children }: { id: string; children: React.ReactNode }) {
  ...
  // Custom hook to maintain
  // We need to implement useOutsideClick hook or copy it
  // Assuming useOutsideClick exists or needs to be created.
  // Using ref for click outside
